...
class DomyPoznanSpider(scrapy.Spider):  # update class to DomyPoznan 
	name = 'domy_poznan'          		#  if you use base of spider but want to scrape other page, you need to updatenem of the spider 
	...
	def parse(self, response):
		...
		self.driver.get('https://www.otodom.pl/sprzedaz/poznan/?search%5Bdescription%5D=1&search%5Bregion_id%5D=15&search%5Bsubregion_id%5D=462&search%5Bcity_id%5D=1&nrAdsPerPage=72')
		sleep(3)
		...
		for item in range(int(number_of_pages)):
			urls.append(f"https://www.otodom.pl/sprzedaz/poznan/?search%5Bdescription%5D=1&search%5Bregion_id%5D=15&search%5Bsubregion_id%5D=462&search%5Bcity_id%5D=1&nrAdsPerPage=72&page={item + 1}")
