...
class GranCanariaSpider(scrapy.Spider):
	...
	def parse(self, response):
		...
		self.driver.get("https://www.idealista.com/en/alquiler-viviendas/las-palmas/gran-canaria/con-metros-cuadrados-mas-de_40,metros-cuadrados-menos-de_100,pisos,de-dos-dormitorios,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas,ultimas-plantas,plantas-intermedias/")
		sleep(2)
		...
		for page in range (pages_count):
			...
			self.driver.set_window_size(randrange(1100, 1200), randrange(800, 900))
			self.driver.get(f"https://www.idealista.com/en/alquiler-viviendas/las-palmas/gran-canaria/con-metros-cuadrados-mas-de_40,metros-cuadrados-menos-de_100,pisos,de-dos-dormitorios,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas,ultimas-plantas,plantas-intermedias/pagina-{page}.htm")
			sleep(1)
			body = self.driver.find_element_by_css_selector('body')
			sleep(1)
